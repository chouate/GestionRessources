...
public class Ordinateur extends Ressource {
    ...
    @Min(value = 1, message = "Le disque dur doit être au moins 1 Go")
    @Max(value = 1024, message = "Le disque dur ne peut pas dépasser 1024 Go")
    private int disqueDur; // En Go

    @NotBlank(message = "L'écran ne peut pas être vide")
    @Size(min = 2, max = 50, message = "L'écran doit avoir entre 2 et 50 caractères")
